...
class SharedServiceClient implements \sharednew\SharedServiceIf {
  ...
  {
    $args = new \sharednew\SharedService_getStruct_args();
    $args->key = $key;
  ...
  public function recv_getStruct()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\sharednew\SharedService_getStruct_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \sharednew\SharedService_getStruct_result();
